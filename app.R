                 ...
                 tabPanel('Age Ranges',
                          ...
                          sidebarLayout(
                                        sidebarPanel(
                                                     ...
                                                     helpText("Regions in Italy (19) and 2 Autonomous Provinces"
                                                              ),
                                                     selectInput("vaccine", h5("Select VACCINE to visualize"),
                                                                 unique(df$fornitore)
                                                                 ),
                                                     helpText("3 Producers of vaccine doses"
                                                              ),
                                                     ...
                                                     helpText("Note: you can plot the absolute numbers of the people vaccinated
                                                              with the dose and in the region selected for the variable of interest
