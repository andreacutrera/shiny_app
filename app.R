...
data <- data[,c(1,2,4,14,16,17,18,19)]
                 ...
                 tabPanel('Age Ranges',
                          ...
                          sidebarLayout(
                                        sidebarPanel(
                                                     ...
                                                     helpText("Producers of vaccine doses admitted by EMA agency (Europen Medicines Agency)"
                                                              ),
                                                     br(),
                ...
                tabPanel('Best Regions',
                         sidebarLayout(
                                       sidebarPanel(
                                                    ...
                                                    helpText("From the 1st to the 21st"
                                                    )
                                                    ),
               ...
               tabPanel('Analysis',
                        sidebarLayout(
                                      sidebarPanel(
                                                   ...
                                                   helpText("9 age ranges categories from 16 to 90+ years old"
                                      ...
                                      mainPanel(
                                                ...
                                                br(),
                                                helpText("Note: use the cursor to interact with the graph"),
                                                helpText("** If the plot does not appear, it means there are no data available for the record choosen")
                                               )
                                     )
                       )
               )
